...
META={
 ...
 ('ucl','es'):("UCL Legends: 83 Equipos Históricos de la Champions | Decempionz",
 ...
 ('copa','es'):("Copa Libertadores: 51 Plantillas Históricas | Decempionz",
 ...
 ('worldcup','es'):("World Cup Legends: 87 Selecciones Históricas | Decempionz",
